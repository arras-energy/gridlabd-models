...
gridlabd -W ${OPENFIDO_INPUT} model/ieee123.glm -o ${OPENFIDO_OUTPUT}/model.html -D html_save_options="--show --cluster"
ls -lR ${OPENFIDO_INPUT}
cp ${OPENFIDO_INPUT}/output/pole_data.csv ${OPENFIDO_OUTPUT}
